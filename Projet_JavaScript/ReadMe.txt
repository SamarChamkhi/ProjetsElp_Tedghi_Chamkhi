...
- 'bing [-k|-p|-c] <processId>' permet de tuer, mettre en pause ou reprendre un processus
- 'CTRL-P' permet de sortir du shell
- 'path' indique l'endroi du path où le programme est executé

Les fonctions précédentes fonctionnent et ont été testées, mais les suivantes ne sont peut être pas fonctionnelles :
